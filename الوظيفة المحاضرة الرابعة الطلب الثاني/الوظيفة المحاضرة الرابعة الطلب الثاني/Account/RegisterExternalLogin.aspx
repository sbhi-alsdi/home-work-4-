<%@ Page Language="C#" Title="Register an external login" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegisterExternalLogin.aspx.cs" Inherits="الوظيفة_المحاضرة_الرابعة_الطلب_الثاني.Account.RegisterExternalLogin" %>
